...
import {useMoviesSearchForm} from '../lib';
...
<template>
    ...
    >
        ...
        <el-form-item v-if="isAdvancedSearch" prop="type">
          <el-radio-group v-model="formValue.type">
            <el-radio value="all">Все категории</el-radio>
            <el-radio value="movie">Фильм</el-radio>
            <el-radio value="series">Сериал</el-radio>
            <el-radio value="game">Игра</el-radio>
          </el-radio-group>
        </el-form-item>

        <el-button native-type="submit" type="primary">Найти</el-button>
        <el-button type="primary" @click="handleClear">Очистить параметры поиска</el-button>
    </el-form>
</template>
